  ...
  providers: [
    ...
    CredentialProvider({
      ...
      authorize: async (credentials) => {
        ...
        try {
          const { data } = await axios.post(Constants.hr_login, {
          ...
          const userData = await axios.get(Constants.hr_me, config);
    ...
    CredentialProvider({
      ...
      authorize: async (credentials) => {
        // console.log(credentials)
        try {
          const { data } = await axios.post(Constants.technical_hr_login, {
            username: credentials?.username,
            password: credentials?.password,
          });
          const config = {
          ...
          const userData = await axios.get(Constants.technical_hr_me, config);
          console.log(userData.data);
    ...
    CredentialProvider({
      ...
      authorize: async (credentials) => {
        try {
          const { data } = await axios.post(Constants.loginEmployer, {
            username: credentials?.username,
            password: credentials?.password,
          });
          const config = {
          ...
          const userData = await axios.get(Constants.me, config);
